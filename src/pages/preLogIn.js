    ...
    return(
        <Container>
            ...
            <Grid container sx={{justifyContent:'center', alignItems:'center', flexDirection:'column', mb: '10rem'}}>
                <StyledButtonPreLogIn variant='contained' sx={{backgroundColor:'#DF4B38'}} onClick={signInWithGoogle}> <GoogleIcon/> Entrar usando Google</StyledButtonPreLogIn>
                <StyledButtonPreLogIn variant='contained'onClick={signInWithFacebook}> <FacebookRoundedIcon/> Entrar usando Facebook</StyledButtonPreLogIn>
                <Link to='/login'>
